...
$$ \lim_{m \to \infty}\ \sum_{i = 0}^{n-1} \left[(a\cdot (\frac{b}{a})^{\frac{i+1}{n}}-a\cdot (\frac{b}{a})^{\frac{i}{n}}) \cdot \left[a\cdot (\frac{b}{a})^{\frac{i}{n}}\right]^{-m} \right] $$
...
求极限将 $\left(\frac{b}{a}\right)^{\frac{1}{n}}$ 表示为自然指数形式：  
   ...
   $$
构造不等式（针对正项）对于足够小的正数 $x$（例如 $x = \frac{\ln \left(\frac{b}{a}\right)}{n}$ 且 $n \to \infty$），指数函数满足：  
   $$
   1 + x \leq e^x \leq 1 + x + x^2.
   $$  
   代入 $x = \frac{\ln \left(\frac{b}{a}\right)}{n}$ 得：  
   $$
   1 + \frac{\ln 2}{n} \leq e^{\frac{\ln 2}{n}} \leq 1 + \frac{\ln 2}{n} + \left( \frac{\ln 2}{n} \right)^2.
   $$  
   两边减 1 后：  
   $$
   \frac{\ln 2}{n} \leq e^{\frac{\ln 2}{n}} - 1 \leq \frac{\ln 2}{n} + \frac{(\ln 2)^2}{n^2}.
   $$
 $$
